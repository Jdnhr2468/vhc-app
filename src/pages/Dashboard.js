...
import {
  ...
  ChevronRight, Smartphone, Flame, Zap, PersonStanding
} from 'lucide-react';
import { useNavigate, useLocation } from 'react-router-dom';
import { auth } from '../services/firebase';
import { addAlert, subscribeAlerts, subscribeDevices } from '../services/firestoreService';
import {
...
export default function Dashboard() {
  ...
  return (
    <Box sx={{ display: 'flex', minHeight: '100vh', bgcolor: theme.bg }}>
      ...
      <MobileHeader title="Dashboard" alertCount={alertCount} />
